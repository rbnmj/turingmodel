...
k_2_range = np.geomspace(0.1, 10, 100)
...
for k_2 in tqdm(k_2_range):
    ...
    for k_1 in k_1_range:
        ...
        H2_extr.append(find_maxima(var[:, 6]+var[:, 7],num_extr))
        ...
        j += 1
    i += 1
np.savetxt("./data/fig7d/H2Slope10-3.csv", slopeH2, delimiter=",")
...
for k_2 in tqdm(k_2_range):
    ...
    for k_1 in k_1_range:
        ...
        j += 1
    i += 1
np.savetxt("./data/fig7d/H2Slope510-3.csv", slopeH2, delimiter=",")
...
for k_2 in tqdm(k_2_range):
    ...
    for k_1 in k_1_range:
        ...
        j += 1
    i += 1
np.savetxt("./data/fig7d/H2Slope10-2.csv", slopeH2, delimiter=",")