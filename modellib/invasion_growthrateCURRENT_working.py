...
k_1_range = np.geomspace(10**-2, 10**0, 15)#50
k_2_range = np.geomspace(10**-2, 10**0, 15)#50
...
k_1_range = np.geomspace(0.1, 10, 15)
ticks = np.append(k_1_range, 10)
...
plt.savefig('./output/test1030/invasion_growthrateV3_'+str(d_Hmax)+'_H2_logV2.png')
...
ax.set_ylabel('$k_2$')
plt.title('Growth rate of $H_2$ \n $d_{H_{max}} = $' + str(d_Hmax) + ', H2 invader')
plt.savefig('./output/test1030/invasion_growthrateV3_'+str(d_Hmax)+'_H2_logV2_binary.png')