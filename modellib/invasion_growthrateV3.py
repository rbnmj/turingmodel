...
# saving results
np.savetxt("./data/growthrateV3_10-2/H1Slope10-2.csv", slopeH1, delimiter=",")
np.savetxt("./data/growthrateV3_10-2/H2Slope10-2.csv", slopeH2, delimiter=",")
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H1-H2.png')
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H1.png')
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H2.png')