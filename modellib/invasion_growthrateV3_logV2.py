...
# saving results
np.savetxt("./data/growthrateV3_10-3/H1Slope10-3_logV2.csv", slopeH1, delimiter=",")
np.savetxt("./data/growthrateV3_10-3/H2Slope10-3_logV2.csv", slopeH2, delimiter=",")
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H1-H2_logV2.png')
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H1_logV2.png')
...
plt.savefig('./output/invasion_growthrateV3_'+str(d_Hmax)+'_H2_logV2.png')