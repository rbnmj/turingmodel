...
class TuringModel:
    ...
    def _equations(self, var, t):
        ...
        dF_1 = Fg_1a * H_1a/(H_1a + H_1b) + Fg_1b * H_1b/(H_1a + H_1b)
        dF_2 = Fg_2a * H_2a/(H_2a + H_2b) + Fg_2b * H_2b/(H_2a + H_2b)
       

        print(dF_1, dF_2, g_1a, g_1b, g_2a, g_2b)
        #return (dN_a, dN_b, dA_a, dA_b, dH_1a, dH_1b, dH_2a, dH_2b, d_H1a, d_H2a, d_H1b, d_H2b, g_2a, g_2b)
        return (dN_a, dN_b, dA_a, dA_b, dH_1a, dH_1b, dH_2a, dH_2b, dF_1, dF_2, g_1a, g_1b, g_2a, g_2b)
