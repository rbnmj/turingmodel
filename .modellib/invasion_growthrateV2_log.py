...
for k_2 in tqdm(k_2_range):
    ...
    for k_1 in k_1_range:
        ...
        slope, intercept, r_value, p_value, std_err = linregress(t[50:999],np.log(var[50:999, 4]))
        H1a[i, j] = slope
        slope, intercept, r_value, p_value, std_err = linregress(t[50:999],np.log(var[50:999, 5]))
        H1b[i, j] = slope
        slope, intercept, r_value, p_value, std_err = linregress(t[50:999],np.log(var[50:999, 6]))
        H2a[i, j] = slope
        slope, intercept, r_value, p_value, std_err = linregress(t[50:999],np.log(var[50:999, 7]))
        H2b[i, j] = slope
        j += 1
    i += 1
...
plt.savefig('./output/invasion_growthrateV2_'+str(d_Hmax)+'_H1-H2_log.png')
...
plt.savefig('./output/invasion_growthrateV2_'+str(d_Hmax)+'_H1_log.png')
...
plt.savefig('./output/invasion_growthrateV2_'+str(d_Hmax)+'_H2_log.png')